...
def _load_image_safe(image_path: str) -> np.ndarray:
    ...
    """
    # Use PIL to correctly handle palette/indexed color images (S1)
    pil_img = Image.open(image_path)
    if pil_img.mode == 'P':
        # Palette mode: convert to RGB to get actual pixel values
    ...
    # Standard orientation is H > W (2115 > 2048)
